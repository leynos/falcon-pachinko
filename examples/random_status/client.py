...
def on_open(ws: websocket.WebSocket) -> None:
    ...
    The status text is taken from the first command-line argument, or defaults to
    "hello" if not provided. The message is sent as a JSON object with "type" set
    to "status" and "payload" containing the status text.
    """
