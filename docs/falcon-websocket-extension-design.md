...
from falcon_pachinko import WebSocketResource, handles_message # Assuming falcon_pachinko is the extension <!-- markdownlint-disable-line MD013 -->
...
```python
async def system_announcement_worker(conn_manager: falcon_pachinko.WebSocketConnectionManager): <!-- markdownlint-disable-line MD013 -->
    while True:
